...
$datos = $conexion->query("SELECT * FROM accesorios_hw");
?>

<table>
  <thead>
  <th>ID</th><th>DESCRIPCION</th><th>MARCA</th>
  <th>MODELO</th><th>TIPO</th><th>FECHA_CR</th>
  <th>HORA_CR</th><th>OBS</th><th>ELIMINAR</th>
  </thead>
  <tbody>
    <?php while($user = mysqli_fetch_array($datos)){ ?>
      <tr>
        <td><?php echo $user['ID_ACCESORIO']; ?></td>
        ...
        <a href="eliminar/eliminar-accesorio.php?ID_ACCESORIO=<?php echo $user['ID_ACCESORIO']; ?>"
