...
<div class="contenedor" id="contenedor">
  ...
  <form  name ="formularioContacto" class="form-actualizar" action="insertar/Accesorios-validar.php" method="post">
     <div class="div-1">
    <label>ID_ACCESORIO:</label><br>
    <input type="number" id="label" name="ID_ACCESORIO">
   </div>
   <div>
   ...
   <div>
    ...
    <input type="date" id="label" name="FECHA_CR" value="<?php echo date("m/d/Y"); ?>"/>
   </div>
   <div>
