...
$datos = $conexion->query("SELECT * FROM bitacora");
?>

<table>
  <thead>
  <th>ID_BITACORA</th><th>N_EQUIPO</th><th>DESCRIPCION</th>
  <th>FECHA_CR</th><th>HORA_CR</th><th>OBS</th><th>ELIMINAR</th>
  </thead>
  <tbody>
    <?php while($user = mysqli_fetch_array($datos)){ ?>
      <tr>
        <td><?php echo $user['ID_BITACORA']; ?></td>
        ...
        <a href="eliminar/eliminar-bitacora.php?ID_BITACORA=<?php echo $user['ID_BITACORA']; ?>"
