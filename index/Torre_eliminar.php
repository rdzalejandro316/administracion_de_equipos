...
$datos = $conexion->query("SELECT * FROM torre");
?>

<table>
  <thead>
  <th>IDTORRE</th><th>DESCRIPCION</th><th>TELEFONO</th>
  <th>DIRECCION</th><th>FECHA_CR</th>
  ...
  <tbody>
    <?php while($user = mysqli_fetch_array($datos)){ ?>
      <tr>
        ...
        <a href="eliminar/eliminar-torre.php?IDTORRE=<?php echo $user['IDTORRE']; ?>"
