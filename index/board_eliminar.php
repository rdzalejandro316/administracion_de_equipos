...
$datos = $conexion->query("SELECT * FROM board");
?>

<table>
  <thead>
  <th>IDBOARD</th><th>MARCA</th>
  <th>MODELO</th><th>FECHA_CR</th>
  ...
  <tbody>
    <?php while($user = mysqli_fetch_array($datos)){ ?>
      <tr>
        ...
        <a href="eliminar/eliminar-board.php?IDBOARD=<?php echo $user['IDBOARD']; ?>"
