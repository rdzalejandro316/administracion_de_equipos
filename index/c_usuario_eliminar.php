...
$datos = $conexion->query("SELECT * FROM c_usuario");
?>

<table>
  <thead>
  <th>ID_USUARIO</th><th>USUARIO</th><th>CLAVE</th>
  <th>ELIMINAR</th>
  </thead>
  <tbody>
    <?php while($user = mysqli_fetch_array($datos)){ ?>
      <tr>
        ...
        <a href="eliminar/eliminar-c_usuario.php?ID_USUARIO=<?php echo $user['ID_USUARIO']; ?>"
