<?php 
  ...
  if (isset($_GET['IDBOARD'])) {
    $datos = $conexion->query("SELECT * FROM board WHERE IDBOARD = '{$_GET['IDBOARD']}'");
...
<ul class="ul-top">
    ...
    <li class="li-top" id="li-top">
      <span class=""><a href="../desconectar.php">Cerrar Sesión</a></span>
    </li>
  </ul>
</nav>
...
<div class="contenedor" id="contenedor">
  ...
  <form  name ="formularioContacto" class="form-actualizar" action="editar-board-guardar.php" method="post">
     <div class="div-1">
   ...
   <div>
    ...
    <div>
    <input type="hidden" name="id" value="<?php echo $union['IDBOARD']; ?>">
