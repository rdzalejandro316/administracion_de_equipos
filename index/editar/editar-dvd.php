<?php 
  ...
  if (isset($_GET['IDUNIDAD_DVD'])) {
    $datos = $conexion->query("SELECT * FROM unidad_dvd WHERE IDUNIDAD_DVD = '{$_GET['IDUNIDAD_DVD']}'");
...
<div class="contenedor" id="contenedor">
  ...
  <form  name ="formularioContacto" class="form-actualizar" action="editar-dvd-guardar.php" method="post">
     <div class="div-1">
   ...
   <div>
    ...
    <div>
    <input type="hidden" name="id" value="<?php echo $union['IDUNIDAD_DVD']; ?>">
