<?php 
  ...
  if (isset($_GET['IDF_PODER'])) {
    $datos = $conexion->query("SELECT * FROM f_poder WHERE IDF_PODER = '{$_GET['IDF_PODER']}'");
...
<div class="contenedor" id="contenedor">
  ...
  <form  name ="formularioContacto" class="form-actualizar" action="editar-f_poder-guardar.php" method="post">
     <div class="div-1">
   ...
   <div>
    <label>VOLTAJE:</label><br>
    <input type="text" id="label" name="VOLTAJE"
    value="<?php echo $union['VOLTAJE']; ?>">
   </div>
   <div>
   ...
   <div>
    ...
    <div>
    <input type="hidden" name="id" value="<?php echo $union['IDF_PODER']; ?>">
