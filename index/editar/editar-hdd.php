<?php 
  ...
  if (isset($_GET['IDHDD'])) {
    $datos = $conexion->query("SELECT * FROM hdd WHERE IDHDD = '{$_GET['IDHDD']}'");
...
<div class="contenedor" id="contenedor">
  ...
  <form  name ="formularioContacto" class="form-actualizar" action="editar-hdd-guardar.php" method="post">
     <div class="div-1">
   ...
   <div>
    ...
    <div>
    <input type="hidden" name="id" value="<?php echo $union['IDHDD']; ?>">
