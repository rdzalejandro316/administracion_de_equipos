<?php 
  ...
  if (isset($_GET['IDPERISFERICO'])) {
    $datos = $conexion->query("SELECT * FROM perisferico WHERE IDPERISFERICO = '{$_GET['IDPERISFERICO']}'");
...
<div class="contenedor" id="contenedor">
  ...
  <form  name ="formularioContacto" class="form-actualizar" action="editar-periferico-guardar.php" method="post">
     <div class="div-1">
    <label>IDPERISFERICO:</label><br>
    <input type="number" id="label" name="IDPERISFERICO"
    value="<?php echo $union['IDPERISFERICO']; ?>">
   </div>
   <div>
   ...
   <div>
    ...
    <input type="text" id="label" name="ACTIVO"
    value="<?php echo $union['ACTIVO']; ?>">
   </div>
   <div>
   ...
   <div>
    ...
    <input type="text" id="label" name="SERIAL"
    value="<?php echo $union['SERIAL']; ?>">
   </div>
   <div>
   ...
   <div>
    ...
    <div>
    <input type="hidden" name="id" value="<?php echo $union['IDPERISFERICO']; ?>">
