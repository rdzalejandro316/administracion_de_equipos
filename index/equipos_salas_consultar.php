...
$sql = "SELECT N_EQUIPO,ACTIVO_PC,PC_GENERICO,SALONES,FECHA_CR,HORA_CR,OBS FROM equipos_salas";
$result = $conexion->query($sql);

if ($result->num_rows > 0) {
     echo "<table><tr><th>N_EQUIPO</th><th>ACTIVO_PC</th><th>PC_GENERICO</th>
     <th>SALONES</th><th>FECHA_CR</th><th>HORA_CR</th><th>OBS</th>
     </tr>";
