...
$datos = $conexion->query("SELECT * FROM equipos_salas");
?>

<table>
  <thead>
  <th>N_EQUIPO</th><th>ACTIVO_PC</th><th>PC_GENERICO</th>
  <th>SALONES</th><th>FECHA_CR</th>
  ...
  <tbody>
    <?php while($user = mysqli_fetch_array($datos)){ ?>
      <tr>
        ...
        <td><?php echo $user['ACTIVO_PC']; ?></td>
        <td><?php echo $user['PC_GENERICO']; ?></td>
        <td><?php echo $user['SALONES']; ?></td>
        <td><?php echo $user['FECHA_CR']; ?></td>
        <td><?php echo $user['HORA_CR']; ?></td>
        <td><?php echo $user['OBS']; ?></td>
        <td class="eliminar_campo">
        <a href="eliminar/eliminar-equipos_salas.php?N_EQUIPO=<?php echo $user['N_EQUIPO']; ?>"
