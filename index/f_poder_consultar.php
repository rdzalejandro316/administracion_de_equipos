...
$sql = "SELECT  IDF_PODER,MARCA,MODELO,VOLTAJE,FECHA_CR,HORA_CR,OBS FROM f_poder";
$result = $conexion->query($sql);

if ($result->num_rows > 0) {
     echo "<table><tr><th>IDF_PODER</th><th>MARCA</th><th>MODELO</th>
     <th>VOLTAJE</th><th>FECHA_CR</th><th>HORA_CR</th><th>OBS</th>
     </tr>";
