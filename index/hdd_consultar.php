...
$sql = "SELECT  IDHDD,MARCA,CAPACIDAD,TIPO,FECHA_CR,HORA_CR,OBS FROM hdd";
$result = $conexion->query($sql);

if ($result->num_rows > 0) {
     echo "<table><tr><th>IDHDD</th><th>MARCA</th><th>CAPACIDAD</th>
     <th>TIPO</th><th>FECHA_CR</th><th>HORA_CR</th><th>OBS</th>
     </tr>";
