...
$datos = $conexion->query("SELECT * FROM pc_generico");
?>

<table>
  <thead>
  <th>IDPC_GEN</th><th>IDBOARD</th><th>IDPROCESADOR</th>
  <th>IDRAM</th><th>IDF_PODER</th>
  <th>IDHDD</th><th>IDUNIDAD_DVD</th><th>IDACCESORIO</th>
  ...
  <tbody>
    <?php while($user = mysqli_fetch_array($datos)){ ?>
      <tr>
        <td><?php echo $user['IDPC_GEN']; ?></td>
        <td><?php echo $user['IDBOARD']; ?></td>
        <td><?php echo $user['IDPROCESADOR']; ?></td>
        <td><?php echo $user['IDRAM']; ?></td>
        <td><?php echo $user['IDF_PODER']; ?></td>
        <td><?php echo $user['IDHDD']; ?></td>
        <td><?php echo $user['IDUNIDAD_DVD']; ?></td>
        <td><?php echo $user['IDACCESORIO']; ?></td>
        <td><?php echo $user['FECHA_CR']; ?></td>
        <td><?php echo $user['HORA_CR']; ?></td>
        <td><?php echo $user['OBS']; ?></td>
        <td class="eliminar_campo">
        <a href="eliminar/eliminar-pc_generico.php?IDPC_GEN=<?php echo $user['IDPC_GEN']; ?>"
