...
$sql = "SELECT IDPROCESADOR,PROCESADOR,MODELO,VELOCIDAD,FECHA_CR,HORA_CR,OBS FROM procesador";
$result = $conexion->query($sql);

if ($result->num_rows > 0) {
     echo "<table><tr><th>IDPROCESADOR</th><th>PROCESADOR</th><th>MODELO</th>
